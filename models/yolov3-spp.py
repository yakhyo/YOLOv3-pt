...
from common import Conv, Bottleneck, SPP, Concat
...
class BACKBONE(nn.Module):
    ...
    def __init__(self, filters, depths):
        ...
        self.b2 = self._make_layers(Bottleneck, filters[2])  # 2
        ...
        self.b6 = self._make_layers(Bottleneck, filters[4], depths[2])  # 6
        self.b7 = Conv(filters[4], filters[5], 3, 2)  # 7-P4/16
        self.b8 = self._make_layers(Bottleneck, filters[5], depths[2])  # 8
    ...
    @staticmethod
    def _make_layers(block, channels, num_depths=1):
        layers = [block(channels, channels) for _ in range(num_depths)]
...
class HEAD(nn.Module):
    ...
    def __init__(self, filters):
        ...
        self.h18 = Concat()  # cat backbone P4 # 18
        ...
        self.h25 = Concat()  # cat backbone P3 # 25
